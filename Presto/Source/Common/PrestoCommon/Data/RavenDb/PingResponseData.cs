...
namespace PrestoCommon.Data.RavenDb
{
    ...
    public class PingResponseData : DataAccessLayerBase, IPingResponseData
    {
        ...
        public PingResponse GetByPingRequestAndServer(PingRequest pingRequest, ApplicationServer appServer)
        {
            ...
            {
                PingResponse pingResponse = QuerySingleResultAndCacheEtag(session => session.Query<PingResponse>()
        ...
        public IEnumerable<PingResponse> GetAllForPingRequest(PingRequest pingRequest)
        {
            ...
            {
                IEnumerable<PingResponse> pingResponses = QueryAndCacheEtags(session => session.Query<PingResponse>()
        ...
        {
            pingResponse.ApplicationServer = QuerySingleResultAndCacheEtag(
