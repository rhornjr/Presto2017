...
namespace PrestoViewModel {
    ...
    internal class ViewModelResources {
        ...
        /// </summary>
        internal static string ItemCannotBeDeletedCaption {
            get {
                return ResourceManager.GetString("ItemCannotBeDeletedCaption", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Server not saved because an environment was not selected..
        /// </summary>
        internal static string ServerNotSavedEnvironmentMissing {
            get {
                return ResourceManager.GetString("ServerNotSavedEnvironmentMissing", resourceCulture);
            }
        }
